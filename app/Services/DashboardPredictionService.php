        ...
        switch ($period) {
            case 'day':
                ...
                for ($i = 0; $i < 24; $i++) {
                    ...
                    $factor = 1.0;
                    if ($i >= 7 && $i <= 9) $factor = 1.5; // Ochtendpiek
                    if ($i >= 18 && $i <= 21) $factor = 1.8; // Avondpiek
                    if ($i >= 0 && $i <= 5) $factor = 0.4; // Nacht
            ...
            case 'year':
                ...
                for ($i = 0; $i < 12; $i++) {
                    // Seizoenspatroon
                    $factor = 1.0;
                    if ($i >= 0 && $i <= 2) $factor = 1.3; // Winter (jan-mar)
                    if ($i >= 3 && $i <= 5) $factor = 0.9; // Lente (apr-jun)
                    if ($i >= 6 && $i <= 8) $factor = $type === 'electricity' ? 1.1 : 0.6; // Zomer (jul-sep)
                    if ($i >= 9 && $i <= 11) $factor = 1.2; // Herfst (okt-dec)
