<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 p-4 bg-white rounded flex justify-between items-center">
                <p class="flex flex-col items-center">Laatste update: <span id="last-updated">{{ $lastRefresh ?? 'Niet beschikbaar' }}</span></p>
                <p class="flex flex-col items-center">Volgende update: <span id="next-update">{{ $nextRefresh ?? 'Niet beschikbaar' }}</span></p>
