        ...
        <form method="POST" action="{{ route('profile.update') }}" class="space-y-8">
            ...
            <div class="bg-gray-800 rounded-lg p-6">
                ...
                <div>
                    ...
                    <textarea name="additional_info" id="additional_info" rows="6" 
                              maxlength="1000"
            ...
            @if($user->activeSuggestions->count() > 0)
                <div class="bg-blue-900 rounded-lg p-6">
                    <h2 class="text-xl font-semibold text-blue-100 mb-4 flex items-center">
                        ...
                        @foreach($user->activeSuggestions as $suggestion)
                            <div class="bg-blue-800 rounded-lg p-4 border border-blue-700">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        <h3 class="font-semibold text-blue-100 mb-2">{{ $suggestion->title }}</h3>
                                        <p class="text-blue-200 mb-2">{{ $suggestion->suggestion }}</p>
